...
const digestInfoHead: any = {
  sha256: "3031300d060960864801650304020105000420",
};

const digestAlgs: any = {
  sha256: SHA256,
};

function RSAVerifier(modulus: any, exp: any): void {
  this.n = null;
  this.e = 0;
...
function getAlgorithmFromDigest(hDigestInfo: any): any {
...
RSAVerifier.prototype.verify = function (msg: any, encodedSignature: any) {
  ...
  const digestInfo: any = getAlgorithmFromDigest(digest);
